			...
			<ul>
				<li>
					<div class="text-score">
						<span class="text-1">当前积分：</span>
						<span id="scores">1234</span>
					<div>
				</li>
				<li>
					<input class="input-lg" id="u-phone" type="tel" placeholder="请输入手机号码（必填）" readonly/>
					<p class="text-error" style="display:none;"></p>
				</li>
			
				<li>
					<input class="input-lg" id="u-name" type="text" placeholder="请输入姓名（必填）" />
					<p class="text-error" style="display:none;" ></p>
				</li>
				
				<li>
					<input class="input-lg" id="u-pass" type="text" placeholder="修改密码(必填)" />
					<p class="text-error" style="display:none;" ></p>
				</li>
			
				<li>
					<input class="input-lg" id="u-shopName" type="text" placeholder="请输入门店（选填）" />
					<p class="text-error" style="display:none;" ></p>
				</li>
			
			</ul>
			<div class="btns">
				<button href="javasrcipt:void(0);" id="modify-btn" >修改</button>
